...
; for assignments. He argues that this will make the interpreter
; more efficient: Since programs usually contain more applications
; than assignments, definitions, and so on, his modified eval will
...
; 
; b. Louis is upset that his plan didn't work. He is willing to go
...
; a
;
; The evaluator does not recognize special forms any more.
; For example, (define x 3) tries to apply function define
; to arguments x and 3.

; b
;
; Procedures "application?", "operator", and "operands"
; below have been changed.
; Note that we have not changed the order of the
; cond clauses in "eval".
...
; Changed to suit the exercise at the beginning of this file.
...
(define primitive-procedures
  (list (list 'car car)
        ...
        (list 'cons cons)
        (list 'null? null?)
	(list 'display display) ; added by tmj
;;      more primitives
        ))
